...
namespace Authorization.WebApi.Controllers
{
    ...
    public class SettingsController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        [Authorize(AuthorizationPolicies.SETTINGS_READ)]
        ...
        [HttpPost]
        [Authorize(AuthorizationPolicies.SETTINGS_ADD)]
        ...
        [HttpPut("{id}")]
        [Authorize(AuthorizationPolicies.SETTINGS_UPDATE)]
        ...
        /// <returns>Action result.</returns>
        [HttpDelete("{id}")]
        [Authorize(AuthorizationPolicies.SETTINGS_DELETE)]
        [ProducesResponseType(StatusCodes.Status204NoContent)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ServiceFilter(typeof(DRFilterAttribute))]
