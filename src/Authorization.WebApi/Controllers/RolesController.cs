...
namespace Authorization.WebApi.Controllers
{
    ...
    public class RolesController : ControllerBase
    {
        ...
        [HttpGet]
        [Authorize(AuthorizationPolicies.ROLE_READ)]
        ...
        [HttpPost]
        [Authorize(AuthorizationPolicies.ROLE_ADD)]
        ...
        [HttpPut("{roleId}")]
        [Authorize(AuthorizationPolicies.ROLE_UPDATE)]
        ...
        /// <returns>Action result.</returns>
        [HttpDelete("{roleId}")]
        [Authorize(AuthorizationPolicies.ROLE_DELETE)]
        [ProducesResponseType(StatusCodes.Status204NoContent)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ServiceFilter(typeof(DRFilterAttribute))]
