...
namespace Authorization.Infrastructure.Gateways.GoogleOAuth2
{
    ...
    /// </summary>
    public class GoogleOAuth2Gateway : IGoogleOAuth2Gateway
    {
        private readonly GoogleOAuth2GatewaySettings _settings;

        /// <summary>
        /// Creates gateway.
        /// </summary>
        /// <param name="settings">Gateway settings.</param>
        public GoogleOAuth2Gateway(GoogleOAuth2GatewaySettings settings)
        {
            _settings = settings;
        }
