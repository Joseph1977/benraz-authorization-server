...
namespace Authorization.EF.Migrations
{
    ...
    [Migration("20210626204741_AddApplicationAccessTokenValidityPeriod")]
    partial class AddApplicationAccessTokenValidityPeriod
    {
            ...
            modelBuilder.Entity("Authorization.Domain.Applications.Application", b =>
                {
                    ...
                    b.Property<TimeSpan?>("AccessTokenValidityPeriod")
                        .HasColumnType("time");
            ...
            modelBuilder.Entity("Authorization.Domain.Settings.SettingsEntry", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = "Emails:ConfirmEmailTemplateId",
                            Description = "Confirmation email template identifier",
                            Value = "8cd5b7d0-df9e-4b66-93ff-1f7e0983e1e4"
                        },
                        new
                        {
                        ...
                        new
                        {
                            Id = "Emails:ResetPasswordTemplateId",
